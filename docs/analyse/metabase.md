...
Q: Jeg har fått tilgang til et datasett i Datamarkedsplassen som er et view, men får likevel en feilmelding i Metabase om manglende tilgang til de underliggende tabellene?  
A: Dette skjer fordi BigQuery som standard krever at man har tilgang til *alle* underliggende tabeller et view bygger på for å kunne lese fra viewet, selv om man har fått tilgang til selve viewet. Løsningen er å [autorisere viewet](https://cloud.google.com/bigquery/docs/share-access-views) i BigQuery-datasettet(ene) til de underliggende tabellene. Da holder det å ha tilgang til viewet alene. Datamarkedsplassen gjør dette automatisk når de underliggende tabellene ligger i samme BigQuery-datasett som viewet, men dersom de ligger i et annet BigQuery-datasett må dette autoriseres manuelt, se avsnittet [Views og Materialized Views](../dataprodukter/tilgangsstyring.md#views-og-materialized-views) under tilgangsstyring for detaljer.